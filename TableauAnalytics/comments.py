...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open('./UnprocessedCSV/{}_facebook_comments.csv'.format(page_id), 'w', encoding ='utf-8') as file:
        w = csv.writer(file)
        ...
        with open('{}_facebook_statuses.csv'.format(page_id), 'r', encoding ='utf-8') as csvfile:
